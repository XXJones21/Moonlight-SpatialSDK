...
assert manifest['sourceRevision'] == '4007df45c6017eccc3354df603b0a97043fda7ae'
...
backup = repo / 'External/local-validation' / datetime.datetime.now().strftime('pre-native-fix-4007df4-%Y%m%d-%H%M%S')
