...
void Java_com_limelight_nvstream_jni_MoonBridge_nativeDecoderSetSurfaceTexture(JNIEnv* env, jclass clazz, jobject surfaceTexture, jint textureId);
void Java_com_limelight_nvstream_jni_MoonBridge_nativeDecoderSetPanelSurface(JNIEnv* env, jclass clazz, jobject surface);
void Java_com_limelight_nvstream_jni_MoonBridge_nativeDecoderSetColorConfig(JNIEnv* env, jclass clazz, jint colorRange, jint colorStandard, jint colorTransfer, jint dataspace);
