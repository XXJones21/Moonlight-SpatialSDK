...
// PosterContentProvider not available in Spatial SDK port
...
public class TvChannelHelper {
    ...
    private void updateChannelIcon(long channelId) {
        // R.drawable.ic_channel not available - create a simple placeholder
        Drawable placeholder = context.getResources().getDrawable(android.R.drawable.ic_menu_gallery);
        Bitmap logo = drawableToBitmap(placeholder);
        try {
    ...
    private Bitmap drawableToBitmap(Drawable drawable) {
        // R.dimen.tv_channel_logo_width not available - use default size
    ...
    void addGameToChannel(ComputerDetails computer, NvApp app) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            PreviewProgramBuilder builder = new PreviewProgramBuilder()
                    ...
                    // PosterContentProvider not available in Spatial SDK
