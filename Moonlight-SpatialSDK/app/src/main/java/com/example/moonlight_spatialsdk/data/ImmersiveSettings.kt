...
data class ImmersiveSettings(
    ...
    /** Enable stereoscopic 3D mode for SBS content (e.g., ReShade SuperDepth3D output) */
    val stereoscopicEnabled: Boolean = false
) {
    companion object {
        ...
        private const val KEY_STEREOSCOPIC = "stereoscopic_enabled"
        ...
        fun load(context: Context): ImmersiveSettings {
            ...
            return ImmersiveSettings(
                ...
                stereoscopicEnabled = prefs.getBoolean(KEY_STEREOSCOPIC, false)
            )
        }
        ...
        fun save(context: Context, settings: ImmersiveSettings) {
            context.getSharedPreferences(PREFS_NAME, Context.MODE_PRIVATE)
                ...
                .putBoolean(KEY_STEREOSCOPIC, settings.stereoscopicEnabled)
                .apply()
        }
    }
}
