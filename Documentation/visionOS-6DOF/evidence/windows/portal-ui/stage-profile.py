"""Back up the closed game's profile and stage the fixed portal UI baseline."""
import datetime
import hashlib
import json
...
package = repo / 'External/local-validation/UEVR-portal-e0d3fa8'
...
assert manifest['sourceRevision'] == 'e0d3fa877f4a9bcf8eb66a8ae7b6b1833a06e904'
...
backup = repo / 'External/local-validation' / datetime.datetime.now().strftime('pre-ui-e0d3fa8-%Y%m%d-%H%M%S')
