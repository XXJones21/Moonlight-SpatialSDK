...
- **ImmersiveActivity** (`Moonlight-SpatialSDK/app/src/main/java/.../ImmersiveActivity.kt`): Main VR activity for connection UI, pairing, video streaming with passthrough, and input handling
- **MoonlightConnectionManager** (`Moonlight-SpatialSDK/app/src/main/java/.../MoonlightConnectionManager.kt`): Connection lifecycle, pairing, stream management, and controller input passthrough
