...
// PcView not available in Spatial SDK port
...
public class StreamSettings extends Activity {
    ...
    void reloadSettings() {
        ...
        // R.id.stream_settings not available in Spatial SDK
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // R.layout.activity_stream_settings not available in Spatial SDK
    ...
    public void onBackPressed() {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.TIRAMISU) {
            ...
            if (!newPrefs.language.equals(previousPrefs.language)) {
                // PcView not available in Spatial SDK - restart not supported
    ...
    public static class SettingsFragment extends PreferenceFragment {
        ...
        private void addNativeFrameRateEntry(float framerate) {
            ...
            String fpsName = "Native (" + fpsValue + " fps)";
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            // R.xml.preferences not available in Spatial SDK
                ...
                public boolean onPreferenceChange(Preference preference, Object newValue) {
                    ...
                    if (isNativeRes) {
                        Dialog.displayDialog(getActivity(),
                                "Native Resolution",
                                "Using native resolution may impact performance",
                                false);
                    }
            ...
            findPreference(PreferenceConfiguration.FPS_PREF_STRING).setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                ...
                public boolean onPreferenceChange(Preference preference, Object newValue) {
                    ...
                    if (nativeFramerateShown && values[values.length - 1].toString().equals(newValue.toString())) {
                        Dialog.displayDialog(getActivity(),
                                "Native Frame Rate",
                                "Using native frame rate may impact performance",
                                false);
                    }
